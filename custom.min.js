    ...
    function newActivity() {
        	...
        	'<div class="row">' +
				'<div class="wizard-steps-container">' +
	        		...
	        		'<div class="steps">' +
		        		...
		        		'<div class="step active"><span class="label jsVerifyActivity">Verifizierung</span></div>' +
       ...
       $( '.js-coins-activity' ).countTo({
            ...
            onComplete: function ( value ) {  
		       ...
		       $( '.jsVerifyActivity' ).html( 'Verifizieren <i class="fas fa-spinner fa-spin"></i>' );
		        ...
		        setTimeout( function() {
		            ...
		            $( '.jsVerifyActivity' ).html( 'Bestätigt <i class="fas fa-check"></i>' );
